...
main_dir          = 'C:/Users/arienne.calonge/OneDrive - VLIZ/Ari/Data/'
out_dir           = 'C:/Users/arienne.calonge/OneDrive - VLIZ/Ari/VLIZ_Network_Analysis/mapping/'

## SET-UP INPUTS

REI_map = 'C:/Users/arienne.calonge/OneDrive - VLIZ/Ari/VLIZ_Network_Analysis/outputs/REI_2023/REI_map.csv'
...
for i in REI_cols: 
    shp_path = out_dir+'REI_interpolation/'+i+'.shp'
    ...
    processing.run("qgis:idwinterpolation", { 'DISTANCE_COEFFICIENT' : 2, 'EXTENT' : '2.186337008,4.304755306,51.069644339,51.895784447 [OGC:CRS84]', 'INTERPOLATION_DATA' : shp_path+'::~::1::~::-1::~::0', 'OUTPUT' : out_dir+'REI_interpolation/'+i+'.tif', 'PIXEL_SIZE' : 0.001377 })
    
    #add output shp and raster
    REI_layer=QgsVectorLayer(shp_path,i)
    interp = QgsRasterLayer(out_dir+'REI_interpolation/'+i+'.tif', i+'.tif') 
    
    QgsProject.instance().addMapLayer(interp)
    QgsProject.instance().addMapLayer(REI_layer)
    
    
#add boundary shpfiles
